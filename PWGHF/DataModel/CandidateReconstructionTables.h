...
DECLARE_SOA_TABLE(HfCandToXiPi, "AOD", "HFCANDTOXIPI",
                  ...
                  hf_track_index::HFflag, hf_cand_toxipi::CpaV0LF, hf_cand_toxipi::CpaCascLF);
...
DECLARE_SOA_TABLE(HfToXiPiMCRec, "AOD", "HFTOXIPIMCREC", //!
                  ...
                  hf_cand_toxipi::CollisionMatched);
...
DECLARE_SOA_COLUMN(PtXicGen, ptXicGen, float);
DECLARE_SOA_COLUMN(PtPionFromXicGen, ptPionFromXicGen, float);
...
DECLARE_SOA_TABLE(HfToXiPiAmbExt, "AOD", "HFTOXIPIAMBEXT",
                  ...
                  hf_cand_toxipi_ambtrk::PtXicGen,  hf_cand_toxipi_ambtrk::PtPionFromXicGen);
