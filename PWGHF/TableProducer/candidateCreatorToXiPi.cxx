...
struct HfCandidateCreatorToXiPi {
  ...
  Preslice<MyCascTableStrTrk> cascadesPerCollisionStrTrk = aod::cascdata::collisionId;
  ...
  PROCESS_SWITCH(HfCandidateCreatorToXiPi, processNoStrTrk, "Do not use strangeness tracking to reconstruct cascades", true);




  // - - - - - process with strangeness tracking for cascade - - - - -
  ...
  PROCESS_SWITCH(HfCandidateCreatorToXiPi, processStrTrk, "Use (only) cascades reconstructed with strangeness tracking", false);
